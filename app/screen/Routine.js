  ...
  const handleRoutineDelete = (id) => {
    db.transaction(tx => {
      tx.executeSql(
        ...
        [id],
        (txObj, resultSet) => { handleRoutineRefresh(); },
        (txObj, error) => console.log(error)
      );
    });
  };
            ...
            <Modal animationIn={'slideInUp'} animationOut={'slideOutDown'} isVisible={visible} onBackdropPress={() => { setVisible(false); setEdit(false); }} onBackButtonPress={() => { setVisible(false); setEdit(false); }}>
              <View style={{ flex: 1, padding: 20, position: 'absolute', bottom: -20, left: -20, backgroundColor: '#fff', width: wp(100), height: hp(50), borderTopLeftRadius: wp(6), borderTopRightRadius: wp(6) }}>
                ...
                <View style={styles.flex_input}>
                  ...
                  <TextInput onChangeText={text => setCourseCode(text)} value={courseCode} style={styles.input} placeholder="e.g.Cse 121" />
                </View>
                <View style={styles.flex_input}>
                  <Text style={styles.label}>Faculty</Text>
                  <TextInput onChangeText={text => setFaculty(text)} value={faculty} style={styles.input} placeholder="e.g. MDI" />
                </View>
                <View style={styles.flex_input}>
                  <Text style={styles.label}>Building</Text>
                  <TextInput keyboardType="number-pad" onChangeText={text => setBuilding(text)} value={building} style={styles.input} placeholder="e.g. 2" />
                </View>
                <View style={styles.flex_input}>
                  <Text style={styles.label}>Room No.</Text>
                  <TextInput keyboardType="number-pad" onChangeText={text => setRoom(text)} value={room} style={styles.input} placeholder="e.g. 901" />
                </View>
                <View style={styles.flex_input}>
                ...
                <View style={[styles.flex_input, { marginTop: hp(1) }]}>
                  ...
                  <TouchableOpacity title="Show Time Picker" onPress={showTimeStartPicker}>
                ...
                <View style={[styles.flex_input, { marginTop: hp(1) }]}>
                  ...
                  <TouchableOpacity title="Show Time Picker" onPress={showTimeEndPicker}>
